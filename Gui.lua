...
local GBaoui = Instance.new("ScreenGui")
GBaoui.Name = ""
GBaoui.Parent = game:GetService("CoreGui").RobloxGui.Modules
GBaoui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
if game:GetService("CoreGui"):FindFirstChild("GBao GUI") then
	game:GetService("CoreGui"):FindFirstChild("GBao GUI"):Destroy()
end
...
Logo.Image = "rbxassetid://"
	...
	Hub.TextColor3 = Color3.fromRGB(0, 260, 225)
	Hub.TextSize = 14.000
	...
	ver1.Text = "N/A"
	ver1.TextColor3 = Color3.fromRGB(0, 260 , 255)
	...
	Ping.Text = "N/A"
	Ping.TextColor3 = Color3.fromRGB(0, 260, 255)
	...
	Fps.Text = "N/A"
	Fps.TextColor3 = Color3.fromRGB(0, 260, 255)
	Fps.TextSize = 13.000
...
Ping.Parent.Text = ("[Ping] : " ..game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString(math.round(2/ping)))
   ...
   UserImageCorner.CornerRadius = UDim.new(0, 100)
	...
	timecock.Text = "N/Q"
	timecock.TextColor3 = Color3.fromRGB(0, 260, 255)
